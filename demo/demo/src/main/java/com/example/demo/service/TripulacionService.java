...
public class TripulacionService {
    ...
    public List<Personal> getPilotos() { return personalRepo.findByCargo("PILOTO"); }
    public List<Personal> getCopilotos() { return personalRepo.findByCargo("COPILOTO"); }
    public List<Personal> getIngenieros() { return personalRepo.findByCargo("INGENIERO"); }
    public List<Personal> getCabina() { return personalRepo.findByCargo("CABINA"); }
